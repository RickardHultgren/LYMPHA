...
document.write("		<div style=\"font-size:1.5vw;margin:0vw 20vw 0vw 20vw ;width:60vw;float:left; margin-bottom:2em;\"><a href=\"index.html\"><img id=\"logopic\" style=\"height:2.5em;width:auto;margin:0.66em 0em 0em 1.33em;\" src=\"logo.png\">");
document.write("		<\/a><span style=\"float:right;display:block;padding:2em 1.5em 0em  0.5em;font-size:0.75em;letter-spacing:0em;color:#6400EF;font-weight:bold;\">BUILDING VALUE IN MEDICAL REASONING<\/span><br>");
document.write("	<div style=\"margin-top:-1em;border-bottom:0.2vw solid #cccccc;text-align:center;z-index:3;width:60vw;position:absolute;top:5em;\">");

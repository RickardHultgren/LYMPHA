...
<br><br>
<span style="display:table;"> [<i class="material-icons" style="background-color:#EFAB00;color:#ffffff;font-size:1.5em;margin-top:.5em; margin-bottom:-.5em;display: table-cell; position: static;vertical-align: middle;">rss_feed</i><span style="vertical-align: middle;table-cell;"> atom feed </span> ](http://rickardhultgren.github.io/lympha/atom.xml)</span>
<br><br>
